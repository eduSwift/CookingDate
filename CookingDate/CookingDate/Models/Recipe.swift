...
extension Recipe {
    ...
    static var mockRecipes = [
        ...
        Recipe(id: UUID().uuidString, image: "Quinoa", name: "Quinoa Salad", description: "A great Quinoa Salad with a spicy kick.", difficulty: "Easy", ingredients: "120g of Quinoa,  letuce, 2 slice of Bread", time: 15),
